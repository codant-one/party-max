    ...
    <VForm
        ...
        <VRow no-gutters>
            ...
            <VCol cols="12" md="12">
                ...
                <VCard class="card-products mx-auto px-0" v-if="props.summary.discount > 0">
                    <h2 class="title-card px-5 px-md-16 my-3 d-flex align-center">
                        ...
                        </svg> &nbsp;&nbsp;&nbsp;Cupón: <strong class="ms-3">{{ props.summary.coupon_code }}</strong>
                    </h2>
                    <VCardTitle class="d-flex title-card px-5 px-md-16 row-cardelivery3">
                        <h4 class="tw-text-yellow">Descuento</h4> 
                        <VSpacer />
                        <h4 class="tw-font-semibold tw-text-yellow">-${{ formatNumber(props.summary.discount) }}</h4>
                    </VCardTitle>
                </VCard>
