   ...
   <VRow>
        <VCol cols="12">
            <VCard class="card-products mx-auto px-0">
                ...
                <h2 class="title-card px-5">Productos</h2>
            ...
            <VCard class="card-products mx-auto px-0">
                <h2 class="title-card px-5">Forma de entrega</h2>
                <VRow class="row-cardelivery3 px-5">
                    <VCol cols="12" md="6" class="text-left">
                        <h4>Calle 000 #000-00</h4>
                    </VCol>
