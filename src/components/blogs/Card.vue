...
watchEffect(() => {
    ...
    if (!(Object.entries(props.blog).length === 0) && props.blog.constructor === Object) {
        ...
        searchTwitter.value = `https://twitter.com/intent/tweet?text=https%3A//${import.meta.env.VITE_MY_DOMAIN}/products/${props.blog.slug}`
        searchPinterest.value = `https://pinterest.com/pin/create/button/?url=&media=https%3A//${import.meta.env.VITE_MY_DOMAIN}/products/${props.blog.slug}`
    ...
    <VCard class="text-justify card-header mb-6 pb-2 card-information no-shadown">
        ...
        <VRow v-if="props.type === 2" class="mb-6">
            ...
            <VCol cols="12" md="12" class="d-flex flex-row align-center px-1 py-1">
                ...
                <VCol cols="9" class="d-flex align-center px-1 py-0 ga-2 ga-md-4">
