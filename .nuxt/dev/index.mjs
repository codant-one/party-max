...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file://C:/laragon/www/party-max/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://C:/laragon/www/party-max/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://C:/laragon/www/party-max/node_modules/devalue/index.js';
import destr from 'file://C:/laragon/www/party-max/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file://C:/laragon/www/party-max/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://C:/laragon/www/party-max/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file://C:/laragon/www/party-max/node_modules/ohash/dist/index.mjs';
import { propsToString, renderSSRHead } from 'file://C:/laragon/www/party-max/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://C:/laragon/www/party-max/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://C:/laragon/www/party-max/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://C:/laragon/www/party-max/node_modules/hookable/dist/index.mjs';
import { klona } from 'file://C:/laragon/www/party-max/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file://C:/laragon/www/party-max/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file://C:/laragon/www/party-max/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file://C:/laragon/www/party-max/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://C:/laragon/www/party-max/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://C:/laragon/www/party-max/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://C:/laragon/www/party-max/node_modules/consola/dist/index.mjs';
import { getContext } from 'file://C:/laragon/www/party-max/node_modules/unctx/dist/index.mjs';
import { isVNode, version, unref } from 'file://C:/laragon/www/party-max/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file://C:/laragon/www/party-max/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://C:/laragon/www/party-max/node_modules/@unhead/shared/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "public": {
    "APP_VERBOSE": "true",
    "APP_DOMAIN_API_URL": "http://backend.partymax",
    "APP_DOMAIN_ADMIN_URL": "http://192.168.0.9:5173",
    "MY_DOMAIN": "localhost:3000",
    "GOOGLE_MANAGER": "G-LTJQR9W7TJ",
    "GOOGLE_TAG_MANAGER": "GTM-MPFBMPB",
...
const serverAssets = [{"baseName":"server","dir":"C:/laragon/www/party-max/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\laragon\\www\\party-max","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\laragon\\www\\party-max\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\laragon\\www\\party-max\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\laragon\\www\\party-max\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\laragon\\www\\party-max\\.data\\kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _oqdYfo63rG = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "C:/laragon/www/party-max";
...
const _lazy_zGkchA = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_zGkchA, lazy: true, middleware: false, method: undefined },
  { route: '/blogs', handler: _lazy_zGkchA, lazy: true, middleware: false, method: undefined },
  { route: '/blogs/*', handler: _lazy_zGkchA, lazy: true, middleware: false, method: undefined },
  { route: '/categories/*', handler: _lazy_zGkchA, lazy: true, middleware: false, method: undefined },
  { route: '/products/*', handler: _lazy_zGkchA, lazy: true, middleware: false, method: undefined },
  { route: '/services/*', handler: _lazy_zGkchA, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_zGkchA, lazy: true, middleware: false, method: undefined }
];
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"icon","type":"image/png","href":"/favicon.png"}],"style":[],"script":[],"noscript":[],"bodyAttrs":{"class":"tw-font-switzer_regular"},"titleTemplate":"%s PARTYMAX"};
...
const getClientManifest = () => import('file://C:/laragon/www/party-max/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://C:/laragon/www/party-max/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
